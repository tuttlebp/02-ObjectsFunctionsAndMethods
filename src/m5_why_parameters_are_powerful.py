...
def main():
    ...
    # better_draw_circles(rg.Point(0, 50), 3)
    even_better_draw_circles(rg.Point(-100, 100), 15, 6, 'blue', 5)
    even_better_draw_circles(rg.Point(100, 100), 15, 6, 'blue', 5)
    even_better_draw_circles(rg.Point(-200, 0), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(-170, -40), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(-140, -80), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(-100, -100), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(-50, -110), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(0, -120), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(50, -110), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(100, -100), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(140, -80), 5, 5, 'blue', 1)
    even_better_draw_circles(rg.Point(170, -40), 5, 5, 'blue', 1)
